...
export default function Header() {
  ...
  return (
    <>
      <header className={`fixed top-0 left-0 right-0 z-50 p-4 transition-all duration-300 ${isScrolled || isMenuOpen ? 'bg-black shadow-lg' : 'bg-gradient-to-b from-black/80 to-transparent'}`}>
            ...
            <div className="relative">
              <form onSubmit={handleSearchSubmit}>
                <input
                  ...
                  onFocus={() => searchTerm.length > 2 && setSuggestions([])}
                  placeholder="Pesquisar..."
                  className="bg-gray-800 border border-gray-700 text-white placeholder-gray-400 text-sm rounded-full py-2 pl-10 pr-4 focus:ring-pink-500 focus:border-pink-500 w-48 transition-all duration-300 focus:w-56"
                />
            ...
            <div className="relative mb-8">
              <form onSubmit={handleSearchSubmit}>
                <input
                  ...
                  className="bg-gray-800 border border-gray-700 w-full text-white placeholder-gray-400 text-base rounded-full py-3 pl-12 pr-4 focus:ring-pink-500 focus:border-pink-500"
                />
